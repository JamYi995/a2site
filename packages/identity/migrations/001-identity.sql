...
CREATE INDEX IF NOT EXISTS idx_a2site_claims_email
  ON a2site_agent_claims(site_id,email,created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_a2site_challenges_claim
  ON a2site_email_challenges(claim_id,created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_a2site_agents_subject
  ON a2site_agent_identities(site_id,subject_id,created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_a2site_credentials_agent
  ON a2site_agent_credentials(agent_identity_id,created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_a2site_identity_events_resource
  ON a2site_identity_events(site_id,resource_type,resource_id,created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_a2site_rate_limits_expiry
  ON a2site_rate_limit_counters(expires_at);
